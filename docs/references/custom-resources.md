...
- [**KongConsumer**](#kongconsumer):
  This resource maps to [Consumer][kong-consumer] entity in Kong.
...
Ingress or Service resource using the following annotation:
...
- To override any properties of related to health-checking, load-balancing,
...
As a reference following is a complete spec for KongIngress:
